...
- 답변1 (인사+분석형 전문가):
  【인사+칭찬】"좋은 질문입니다! ${target}님, 이렇게 꼼꼼히 확인하시려는 거 정말 현명하세요."
...
- 답변2 (경험담+비교형 전문가):
  【인사+경험】"안녕하세요! ${target}님과 비슷한 분들 상담 정말 많이 해봤어요."
...
[답변1]
좋은 질문입니다! ${target}님, 이렇게 미리 확인하시려는 거 정말 현명하세요.
...
${target}님, 너무 자책하지 마세요. 이건 몰라서 그런 거예요.
증권 사진 올려주시면 구체적으로 분석해드릴게요!

[답변2]
안녕하세요! ${target}님과 비슷한 분들 상담 정말 많이 해봤어요.
...
[답변3]
${target}님, 내용 잘 정리해서 올려주셨어요. 고민 많으시죠ㅠㅠ
...
${target}님, 위 분석은 증권 사진 기반으로 작성되었습니다. 추가 질문은 댓글로 남겨주세요!` : `
[핵심 수치]
