...
[답변1]
★ A.G.E.N.T Logic 구조로 작성! ★
- 먼저 강렬한 한 줄 공감/경고 문장으로 시작 (예: "지인분의 말씀만 듣고 섣불리 해지하셨다면 정말 큰일 날 뻔하셨습니다.")
- A (Attention): 고객의 고통에 공감
- G (General Error): 잘못된 영업 방식 지적하며 고객 편에 서기
- E (Experience & Evidence): 20년 경험과 근거 제시
- N (New Solution): 구체적인 대안 제시
- T (Trigger): 증권 확인 또는 상담 요청 유도 질문
- 450-650자
- 핵심 키워드 3회 이상 자연 배치
