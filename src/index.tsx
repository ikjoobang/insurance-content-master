...
==========================================================
【 출력 형식 - 반드시 아래 형식 그대로 출력 (질문 2개, 답변 3개) 】
==========================================================
...
================== 질문 1 ==================
[질문1]
★★★ 상황 A: ${hasKeyword ? `"${customerConcern}" 핵심 고민 중심!` : '설계사 제안 상황'} ★★★
- ${target}의 말투로 작성 (보험 초보의 불안하고 답답한 심정)
- 인사 + 자기소개 (나이, 상황)
- 최근 겪은 일: 설계사에게 리모델링/신규 가입 제안 받은 상황
- ${hasKeyword ? `핵심 고민: "${customerConcern}"` : `${insuranceType} 관련 제안 받은 상황`}
- 숫자 인용 (월 XX만원, X년 납입 등)
...
4. 강력한 CTA (구체적 행동 지시)
   예: "증권 3페이지 **해지환급금 예시표** 사진 찍어 댓글 주세요!"
...
[답변2]
★★★ [답변1]과 다른 관점의 전문가! ★★★
[질문1] 또는 [질문2]에 대한 답변 - 분석형 전문가

- 다른 스타일: 데이터/통계 중심, 비교 분석
- 같은 가독성 규칙 (4줄 금지, **볼드**, ✅⚠️💡)
- 다른 관점에서 해결책 제시
- 강력한 CTA로 마무리
- 500-700자
